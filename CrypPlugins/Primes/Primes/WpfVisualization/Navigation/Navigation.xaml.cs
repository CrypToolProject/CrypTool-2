    ...
    public partial class Navigation : UserControl
    {
        ...
        private void lnk_Click(object sender, RoutedEventArgs e)
        {
            if (OnNavigate != null)
            {
                ...
                else if (sender == lnkDistribNumberrec) commandtype = NavigationCommandType.PrimeDistrib_Numberrec;
                else if (sender == lnkDistribUlam) commandtype = NavigationCommandType.PrimeDistrib_Ulam;
                else if (sender == lnkPrimitivRoots) commandtype = NavigationCommandType.PrimitivRoot;
                else if (sender == lnkGenPrimes) commandtype = NavigationCommandType.Primesgeneration;
                else if (sender == lnkCountPrimes) commandtype = NavigationCommandType.Graph;
                else if (sender == lnkStartPage) commandtype = NavigationCommandType.Start;
                else if (sender == lnkNumberTheoryFunctions) commandtype = NavigationCommandType.NumberTheoryFunctions;
