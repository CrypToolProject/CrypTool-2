...
namespace DCAKeyRecovery.Logic.Cipher3
{
    public static class Cipher3Configuration
    {
        ...
        public static readonly ushort[] PBOX = { 0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15 };
        public static readonly ushort[] SBOXREVERSE = { 4, 8, 6, 10, 1, 3, 0, 5, 12, 14, 13, 15, 2, 11, 7, 9 };
        public static readonly ushort[] PBOXREVERSE = { 0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15 };
