...
namespace CrypTool.PRESENT {
    class KS_Animation {
        ...
        private GeometryModel3D[] gma3D_keyreg = new GeometryModel3D[80];
        private GeometryModel3D[] gma3D_roundcounter = new GeometryModel3D[5];
        private GeometryModel3D[] gma3D_roundcountertemp = new GeometryModel3D[5];
        ...
        void KeyShiftCompleted() {
            for (int i = 0; i < 80; i++) gma3D_keyreg[i].Transform = null;
        ...
        private void KeySboxIntegrate() {
            TranslateTransform3D tt = new TranslateTransform3D();
            for (int i = 76; i < 80; i++) gma3D_keyreg[i].Transform = tt;
        ...
        void KeySboxIntegrateCompleted() {
            Color_Sbox(0);
