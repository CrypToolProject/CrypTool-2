...
namespace CrypTool.Plugins.HagelinMachine
{
    ...
    {
        #region Model
        [TaskPane("ModelCaption", "ModelTip", "Hagelin model", 19, false, ControlType.ComboBox, new string[] { "CX-52a", "CX-52b", "CX-52c", "C-52d", "C-XM", "C-XM late version", "France", "EIRE", "M209", "Custom" })]
