...
namespace CrypTool.Plugins.Blowfish
{
    ...
    internal class BlowfishAlgorithm
    {
        ...
        {
            uint l = (uint)(plaintext[0] << 24 | plaintext[1] << 16 | plaintext[2] << 8 | plaintext[3]);
            uint r = (uint)(plaintext[4] << 24 | plaintext[5] << 16 | plaintext[6] << 8 | plaintext[7]);
            Encrypt(ref l, ref r);
            return new byte[]
            {
                (byte)(l >> 24),
        ...
        public byte[] Decrypt(byte[] ciphertext, byte[] key)
        {
            ...
            uint r = (uint)(ciphertext[4] << 24 | ciphertext[5] << 16 | ciphertext[6] << 8 | ciphertext[7]);
            Decrypt(ref l, ref r);
            return new byte[]
            {
                (byte)(l >> 24),
        ...
        /// <summary>
        /// Internal encryption method of Blowfish
        /// </summary>
        /// <param name="L"></param>
        /// <param name="R"></param>
        ...
        /// <summary>
        /// Internal decryption method of Blowfish
        /// </summary>
        /// <param name="L"></param>
        /// <param name="R"></param>
