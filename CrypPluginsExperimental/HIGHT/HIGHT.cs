...
namespace CrypTool.HIGHT
{
    ...
    public class HIGHT : ICrypComponent
    {
        ...
        {
            get => settings;
            set => settings = (HIGHTSettings)value;
        }
        ...
        {
            get => inputStream;
            set => inputStream = value;// wander 20100208: unnecessary event, should be propagated by editor//OnPropertyChanged("InputStream");
        }
