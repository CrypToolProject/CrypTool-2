...
namespace CrypTool.Feistel
{
    ...
    {
        #region Public Feistel specific interface

        /// <summary>
        /// We use this delegate to send log messages from the settings class to the Feistel plugin
        /// </summary>
        public delegate void FeistelLogMessage(string msg, NotificationLevel loglevel);

        public enum FeistelMode { Encrypt = 0, Decrypt = 1 };
      ...
      //  public enum UnknownSymbolHandlingMode { Ignore = 0, Remove = 1, Replace = 2 };
        ...
        /// </summary>
        public event FeistelLogMessage LogMessage;

        #endregion

        #region Private variables and public constructor

        private FeistelMode selectedAction = FeistelMode.Encrypt;
        

        public FeistelSettings()
        {
