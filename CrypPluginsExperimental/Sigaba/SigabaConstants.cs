...
namespace Sigaba
{
    class SigabaConstants
    {
        ...
        public static readonly char[][] ControlCipherRotors = new string[]
        {
        ...
        public static readonly int[][] IndexRotors =
        { 
        ...
        {    
            new int[] {9, 1, 2, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 6, 7, 7, 7, 7, 7, 8, 8, 8, 8, 8, 8 },
