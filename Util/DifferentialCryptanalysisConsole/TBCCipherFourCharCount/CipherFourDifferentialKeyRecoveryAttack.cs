...
{
    class CipherFourDifferentialKeyRecoveryAttack : DifferentialKeyRecoveryAttack
    {
        public bool recoveredSubkey6;
        ...
        public CipherFourDifferentialKeyRecoveryAttack()
        {
        ...
        public override string printRecoveredSubkeyBits()
        {
            ...
            if (recoveredSubkey6)
            {
                ...
                first = false;
                sb.Append("Binary K5: ");
                keyBits = new BitArray(BitConverter.GetBytes(subkey6));
