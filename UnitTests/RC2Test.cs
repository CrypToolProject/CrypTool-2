...
namespace Tests.TemplateAndPluginTests
{
    ...
    public class RC2Test
    {
        ...
        {
            var pluginInstance = TestHelpers.GetPluginInstance("RC2");
            var scenario = new PluginTestScenario(pluginInstance, new[] { "InputStream", "InputIV", "InputKey", ".Action", ".Padding" }, new[] { "OutputStream" });
