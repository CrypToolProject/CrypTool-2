...
//
// $HeadURL: https://svn.CrypTool.org/CrypTool2/trunk/LibSource/SSCext/TwofishBase.cs $
//////////////////////////////////////////////////////////////////////////////////////////////////
// $Revision:: 8109                                                                           $://
// $Author:: kopal                                                                            $://
        ...
        for (int i = 0; i < subKeys.Length; i++)
          Debug.WriteLine("SubKey " + subKeys[i].ToString("x"));
            ...
            *
            ...
            // TODO: not the most efficient use of code but it allows us to update 
            // the code a lot quicker we can possibly optimize this code once we have got it all working
            ...
            */
            ...
            private static readonly byte[,] p8 =
                {
			    /*  p0:   */
				  {
