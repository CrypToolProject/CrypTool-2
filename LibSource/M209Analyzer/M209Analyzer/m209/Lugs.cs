...
namespace M209AnalyzerLib.M209
{
    public class Lugs
    {
        ...
        private static bool AcceptMultipleSimilarOverlaps(int same)
        {
            ...
            int reference = 64;
            long rand = Common.Utils.RandomNextInt(reference);
        ...
        private void RandomizePrivate(int requiredOverlap)
        {
            ...
            while (true)
            {
                int seqIndex = Common.Utils.RandomNextInt(LugsRules.validLugCountSequences.Count());
