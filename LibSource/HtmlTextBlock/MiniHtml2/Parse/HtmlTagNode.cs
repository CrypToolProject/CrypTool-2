...
namespace QuickZip.MiniHtml2
{
    public class HtmlTagNode : IEnumerable
    {
        ...
        public HtmlTagNode Parent => parentNode;
        ///<summary> Gets subnodes of this node. </summary>
        public List<HtmlTagNode> Items => childTags;
        ...
        public bool isContainer => childTags.Count > 0;

        public bool isBlock => Defines.BuiltinTags[tag.ID].flags == HTMLFlag.Region;
