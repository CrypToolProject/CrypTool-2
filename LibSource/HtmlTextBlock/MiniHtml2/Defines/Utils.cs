...
namespace QuickZip.MiniHtml2
{
    ...
    public class Utils
    {
        ...
        private static void locateNextVariable(ref string working, ref string varName, ref string varValue)
        {
            ...
            int pos1 = working.IndexOf('=');
            if (pos1 != -1)
            {
                varName = working.Substring(0, pos1);
                int j = working.IndexOf('"');
                int f1 = working.IndexOf(' ');
                int f2 = working.IndexOf('=');
                if (f1 == -1) { f1 = f2 + 1; }
        ...
        /// </summary>        
        public static int LocateSymbol(string input)
        {
        ...
        public static string DecodeSymbol(string input)
        {
            ...
            if ((Idx1 != -1) && (Idx2 > Idx1))
            {
                ...
                {
                    int symbIndex = LocateSymbol('&' + symb + ';');
                    if (symbIndex != -1)
        ...
        public static Color String2Color(string colorString)
        {
            ...
            if (colorString.ToLower().Equals("aliceblue")) { return Color.AliceBlue; }
            else
            if (colorString.ToLower().Equals("antiquewhite")) { return Color.AntiqueWhite; }
            else
            if (colorString.ToLower().Equals("aqua")) { return Color.Aqua; }
            else
            if (colorString.ToLower().Equals("aquamarine")) { return Color.Aquamarine; }
            else
            if (colorString.ToLower().Equals("azure")) { return Color.Azure; }
            else
            if (colorString.ToLower().Equals("beige")) { return Color.Beige; }
            else
            if (colorString.ToLower().Equals("bisque")) { return Color.Bisque; }
            else
            if (colorString.ToLower().Equals("black")) { return Color.Black; }
            else
            if (colorString.ToLower().Equals("blanchedalmond")) { return Color.BlanchedAlmond; }
            else
            if (colorString.ToLower().Equals("blue")) { return Color.Blue; }
            else
            if (colorString.ToLower().Equals("blueviolet")) { return Color.BlueViolet; }
            else
            if (colorString.ToLower().Equals("brown")) { return Color.Brown; }
            else
            if (colorString.ToLower().Equals("burlywood")) { return Color.BurlyWood; }
            else
            if (colorString.ToLower().Equals("cadetblue")) { return Color.CadetBlue; }
            else
            if (colorString.ToLower().Equals("chartreuse")) { return Color.Chartreuse; }
            else
            if (colorString.ToLower().Equals("chocolate")) { return Color.Chocolate; }
            else
            if (colorString.ToLower().Equals("coral")) { return Color.Coral; }
            else
            if (colorString.ToLower().Equals("cornflowerblue")) { return Color.CornflowerBlue; }
            else
            if (colorString.ToLower().Equals("cornsilk")) { return Color.Cornsilk; }
            else
            if (colorString.ToLower().Equals("crimson")) { return Color.Crimson; }
            else
            if (colorString.ToLower().Equals("cyan")) { return Color.Cyan; }
            else
            if (colorString.ToLower().Equals("darkblue")) { return Color.DarkBlue; }
            else
            if (colorString.ToLower().Equals("darkcyan")) { return Color.DarkCyan; }
            else
            if (colorString.ToLower().Equals("darkgoldenrod")) { return Color.DarkGoldenrod; }
            else
            if (colorString.ToLower().Equals("darkgray")) { return Color.DarkGray; }
            else
            if (colorString.ToLower().Equals("darkgreen")) { return Color.DarkGreen; }
            else
            if (colorString.ToLower().Equals("darkkhaki")) { return Color.DarkKhaki; }
            else
            if (colorString.ToLower().Equals("darkmagenta")) { return Color.DarkMagenta; }
            else
            if (colorString.ToLower().Equals("darkolivegreen")) { return Color.DarkOliveGreen; }
            else
            if (colorString.ToLower().Equals("darkorange")) { return Color.DarkOrange; }
            else
            if (colorString.ToLower().Equals("darkorchid")) { return Color.DarkOrchid; }
            else
            if (colorString.ToLower().Equals("darkred")) { return Color.DarkRed; }
            else
            if (colorString.ToLower().Equals("darksalmon")) { return Color.DarkSalmon; }
            else
            if (colorString.ToLower().Equals("darkseagreen")) { return Color.DarkSeaGreen; }
            else
            if (colorString.ToLower().Equals("darkslateblue")) { return Color.DarkSlateBlue; }
            else
            if (colorString.ToLower().Equals("darkslategray")) { return Color.DarkSlateGray; }
            else
            if (colorString.ToLower().Equals("darkturquoise")) { return Color.DarkTurquoise; }
            else
            if (colorString.ToLower().Equals("darkviolet")) { return Color.DarkViolet; }
            else
            if (colorString.ToLower().Equals("deeppink")) { return Color.DeepPink; }
            else
            if (colorString.ToLower().Equals("deepskyblue")) { return Color.DeepSkyBlue; }
            else
            if (colorString.ToLower().Equals("dimgray")) { return Color.DimGray; }
            else
            if (colorString.ToLower().Equals("dodgerblue")) { return Color.DodgerBlue; }
            else
            if (colorString.ToLower().Equals("firebrick")) { return Color.Firebrick; }
            else
            if (colorString.ToLower().Equals("floralwhite")) { return Color.FloralWhite; }
            else
            if (colorString.ToLower().Equals("forestgreen")) { return Color.ForestGreen; }
            else
            if (colorString.ToLower().Equals("fuchsia")) { return Color.Fuchsia; }
            else
            if (colorString.ToLower().Equals("gainsboro")) { return Color.Gainsboro; }
            else
            if (colorString.ToLower().Equals("ghostwhite")) { return Color.GhostWhite; }
            else
            if (colorString.ToLower().Equals("gold")) { return Color.Gold; }
            else
            if (colorString.ToLower().Equals("goldenrod")) { return Color.Goldenrod; }
            else
            if (colorString.ToLower().Equals("gray")) { return Color.Gray; }
            else
            if (colorString.ToLower().Equals("green")) { return Color.Green; }
            else
            if (colorString.ToLower().Equals("greenyellow")) { return Color.GreenYellow; }
            else
            if (colorString.ToLower().Equals("honeydew")) { return Color.Honeydew; }
            else
            if (colorString.ToLower().Equals("hotpink")) { return Color.HotPink; }
            else
            if (colorString.ToLower().Equals("indianred")) { return Color.IndianRed; }
            else
            if (colorString.ToLower().Equals("indigo")) { return Color.Indigo; }
            else
            if (colorString.ToLower().Equals("ivory")) { return Color.Ivory; }
            else
            if (colorString.ToLower().Equals("khaki")) { return Color.Khaki; }
            else
            if (colorString.ToLower().Equals("lavender")) { return Color.Lavender; }
            else
            if (colorString.ToLower().Equals("lavenderblush")) { return Color.LavenderBlush; }
            else
            if (colorString.ToLower().Equals("lawngreen")) { return Color.LawnGreen; }
            else
            if (colorString.ToLower().Equals("lemonchiffon")) { return Color.LemonChiffon; }
            else
            if (colorString.ToLower().Equals("lightblue")) { return Color.LightBlue; }
            else
            if (colorString.ToLower().Equals("lightcoral")) { return Color.LightCoral; }
            else
            if (colorString.ToLower().Equals("lightcyan")) { return Color.LightCyan; }
            else
            if (colorString.ToLower().Equals("lightgoldenrodyellow")) { return Color.LightGoldenrodYellow; }
            else
            if (colorString.ToLower().Equals("lightgray")) { return Color.LightGray; }
            else
            if (colorString.ToLower().Equals("lightgreen")) { return Color.LightGreen; }
            else
            if (colorString.ToLower().Equals("lightpink")) { return Color.LightPink; }
            else
            if (colorString.ToLower().Equals("lightsalmon")) { return Color.LightSalmon; }
            else
            if (colorString.ToLower().Equals("lightseagreen")) { return Color.LightSeaGreen; }
            else
            if (colorString.ToLower().Equals("lightskyblue")) { return Color.LightSkyBlue; }
            else
            if (colorString.ToLower().Equals("lightslategray")) { return Color.LightSlateGray; }
            else
            if (colorString.ToLower().Equals("lightsteelblue")) { return Color.LightSteelBlue; }
            else
            if (colorString.ToLower().Equals("lightyellow")) { return Color.LightYellow; }
            else
            if (colorString.ToLower().Equals("lime")) { return Color.Lime; }
            else
            if (colorString.ToLower().Equals("limegreen")) { return Color.LimeGreen; }
            else
            if (colorString.ToLower().Equals("linen")) { return Color.Linen; }
            else
            if (colorString.ToLower().Equals("magenta")) { return Color.Magenta; }
            else
            if (colorString.ToLower().Equals("maroon")) { return Color.Maroon; }
            else
            if (colorString.ToLower().Equals("mediumaquamarine")) { return Color.MediumAquamarine; }
            else
            if (colorString.ToLower().Equals("mediumblue")) { return Color.MediumBlue; }
            else
            if (colorString.ToLower().Equals("mediumorchid")) { return Color.MediumOrchid; }
            else
            if (colorString.ToLower().Equals("mediumpurple")) { return Color.MediumPurple; }
            else
            if (colorString.ToLower().Equals("mediumseagreen")) { return Color.MediumSeaGreen; }
            else
            if (colorString.ToLower().Equals("mediumslateblue")) { return Color.MediumSlateBlue; }
            else
            if (colorString.ToLower().Equals("mediumspringgreen")) { return Color.MediumSpringGreen; }
            else
            if (colorString.ToLower().Equals("mediumturquoise")) { return Color.MediumTurquoise; }
            else
            if (colorString.ToLower().Equals("mediumvioletred")) { return Color.MediumVioletRed; }
            else
            if (colorString.ToLower().Equals("midnightblue")) { return Color.MidnightBlue; }
            else
            if (colorString.ToLower().Equals("mintcream")) { return Color.MintCream; }
            else
            if (colorString.ToLower().Equals("mistyrose")) { return Color.MistyRose; }
            else
            if (colorString.ToLower().Equals("moccasin")) { return Color.Moccasin; }
            else
            if (colorString.ToLower().Equals("navajowhite")) { return Color.NavajoWhite; }
            else
            if (colorString.ToLower().Equals("navy")) { return Color.Navy; }
            else
            if (colorString.ToLower().Equals("oldlace")) { return Color.OldLace; }
            else
            if (colorString.ToLower().Equals("olive")) { return Color.Olive; }
            else
            if (colorString.ToLower().Equals("olivedrab")) { return Color.OliveDrab; }
            else
            if (colorString.ToLower().Equals("orange")) { return Color.Orange; }
            else
            if (colorString.ToLower().Equals("orangered")) { return Color.OrangeRed; }
            else
            if (colorString.ToLower().Equals("orchid")) { return Color.Orchid; }
            else
            if (colorString.ToLower().Equals("palegoldenrod")) { return Color.PaleGoldenrod; }
            else
            if (colorString.ToLower().Equals("palegreen")) { return Color.PaleGreen; }
            else
            if (colorString.ToLower().Equals("paleturquoise")) { return Color.PaleTurquoise; }
            else
            if (colorString.ToLower().Equals("palevioletred")) { return Color.PaleVioletRed; }
            else
            if (colorString.ToLower().Equals("papayawhip")) { return Color.PapayaWhip; }
            else
            if (colorString.ToLower().Equals("peachpuff")) { return Color.PeachPuff; }
            else
            if (colorString.ToLower().Equals("peru")) { return Color.Peru; }
            else
            if (colorString.ToLower().Equals("pink")) { return Color.Pink; }
            else
            if (colorString.ToLower().Equals("plum")) { return Color.Plum; }
            else
            if (colorString.ToLower().Equals("powderblue")) { return Color.PowderBlue; }
            else
            if (colorString.ToLower().Equals("purple")) { return Color.Purple; }
            else
            if (colorString.ToLower().Equals("red")) { return Color.Red; }
            else
            if (colorString.ToLower().Equals("rosybrown")) { return Color.RosyBrown; }
            else
            if (colorString.ToLower().Equals("royalblue")) { return Color.RoyalBlue; }
            else
            if (colorString.ToLower().Equals("saddlebrown")) { return Color.SaddleBrown; }
            else
            if (colorString.ToLower().Equals("salmon")) { return Color.Salmon; }
            else
            if (colorString.ToLower().Equals("sandybrown")) { return Color.SandyBrown; }
            else
            if (colorString.ToLower().Equals("seagreen")) { return Color.SeaGreen; }
            else
            if (colorString.ToLower().Equals("seashell")) { return Color.SeaShell; }
            else
            if (colorString.ToLower().Equals("sienna")) { return Color.Sienna; }
            else
            if (colorString.ToLower().Equals("silver")) { return Color.Silver; }
            else
            if (colorString.ToLower().Equals("skyblue")) { return Color.SkyBlue; }
            else
            if (colorString.ToLower().Equals("slateblue")) { return Color.SlateBlue; }
            else
            if (colorString.ToLower().Equals("slategray")) { return Color.SlateGray; }
            else
            if (colorString.ToLower().Equals("snow")) { return Color.Snow; }
            else
            if (colorString.ToLower().Equals("springgreen")) { return Color.SpringGreen; }
            else
            if (colorString.ToLower().Equals("steelblue")) { return Color.SteelBlue; }
            else
            if (colorString.ToLower().Equals("tan")) { return Color.Tan; }
            else
            if (colorString.ToLower().Equals("teal")) { return Color.Teal; }
            else
            if (colorString.ToLower().Equals("thistle")) { return Color.Thistle; }
            else
            if (colorString.ToLower().Equals("tomato")) { return Color.Tomato; }
            else
            if (colorString.ToLower().Equals("transparent")) { return Color.Transparent; }
            else
            if (colorString.ToLower().Equals("turquoise")) { return Color.Turquoise; }
            else
            if (colorString.ToLower().Equals("violet")) { return Color.Violet; }
            else
            if (colorString.ToLower().Equals("wheat")) { return Color.Wheat; }
            else
            if (colorString.ToLower().Equals("white")) { return Color.White; }
            else
            if (colorString.ToLower().Equals("whitesmoke")) { return Color.WhiteSmoke; }
            else
            if (colorString.ToLower().Equals("yellow")) { return Color.Yellow; }
            else
            if (colorString.ToLower().Equals("yellowgreen")) { return Color.YellowGreen; }
            else
            {
                return Color.Black;
            }
        ...
        public static Color WebColor2Color(string colorString)
        {
            try
            {
                ...
                if (colorString[0] == '#')
                {
                    int red = Convert.ToInt32(colorString.Substring(1, 2), 16);
                    int green = Convert.ToInt32(colorString.Substring(3, 2), 16);
                    int blue = Convert.ToInt32(colorString.Substring(5, 2), 16);
        ...
        /// <returns></returns>
        public static int StrSize2PixelSize(string sizeString, int def)
        {
            bool plusSign = false;
            ...
            float number = Convert.ToSingle(sizeStr.Substring(0, intPos + 1));
        ...
        public static string Number2Romans(uint value)
        {
            StringBuilder retVal = new StringBuilder();
            int romIndex = 0;
            while (value > 0)
            {
                uint romVal = Defines.BuiltinRomans[romIndex].value;
                if (value >= romVal)
                {
                    value -= romVal;
        ...
        public static string Number2BulletValue(uint value, bulletStyleType styleType)
        {
            switch (styleType)
            {
        ...
        public static int LocateTag(string tagName)
        {
        ...
        public static int LocateBBCode(string tagName)
        {
            tagName = tagName.ToLower();
        ...
        /// </summary>
        public static int LocateStyle(string styleName)
        {
            styleName = styleName.ToLower();
            for (int i = 0; i < Defines.BuiltinStyles.Length; i++)
            {
        ...
        /// </summary>
        public static Font CreateFont(string aFontName, int aFontSize, bool isBold, bool isItalic,
        ...
        /// </summary>
        public static Pen CreatePen(Color aColor, int aSize)
        {
#if CF
        ...
        /// </summary>
        public static Pen CreatePen(Brush aBrush, int aSize)
        {
#if CF
        ...
        public static SizeF TextSize2(Graphics g, string aText, Font aFont)
        {
            ...
            int precision = (int)(defSize.Width / 50);
            ...
            try
            {
                ...
                for (int x = (int)defSize.Width - 1; x > 0; x = x - precision)
                {
                    for (int y = (int)defSize.Height - 1; y > 0; y--)
                    {
                        ...
                        {
                            return new SizeF(x, defSize.Height);
                        }
                    }
                }
            }
        ...
        /// </summary>
        public static int TextPosition(Graphics g, string aText, Font aFont, float x)
        {
            float fullWidth = TextSize(g, aText, aFont).Width;
            int precision = aText.Length / 5;
            int start = (int)(Math.Round(x / fullWidth * aText.Length)) - precision + 1;
            if (start < 1) { start = 1; }
        ...
        /// </summary>
        public static int TextPosition2(Graphics g, string aText, Font aFont, float x)
        {
            if (aText == "")
            {
                return 0;
        ...
        public static void DrawCircle(Graphics g, int x, int y, int size)
        {
            ...
            g.FillEllipse(Brushes.Lime, x, y, size, (float)size);

        }
        /// <summary>
        /// Output a triangle.
        /// </summary>            
        public static void DrawTriangle(Graphics g, int x, int y, int width, int height, bool down)
        {
        ...
        public static Image ResizeImage(Image input, float percentage)
        {
            ...
            Bitmap tn = new Bitmap((int)(input.Width * 0.01f * percentage), (int)(input.Height * 0.01f * percentage));
        ...
        /// Resize a Image and return it
        /// </summary>
        public static Image ResizeImage(Image input, int maxWidth, int maxHeight)
        {
            float percentageW = maxWidth / (float)input.Width * 100;
            float percentageH = maxHeight / (float)input.Height * 100;
        ...
        /// Resize a Image and return it
        /// </summary>
        public static Image ResizeImageW(Image input, int width)
        {
            float percentage = width / (float)input.Width * 100;
            return ResizeImage(input, percentage);
        }
        /// <summary>
        /// Resize a Image and return it
        /// </summary>
        public static Image ResizeImageH(Image input, int height)
        {
            float percentage = height / (float)input.Height * 100;
            return ResizeImage(input, percentage);
        }
        ...
        public static bool Run2(string prog, string param, ref ProcessInfo pi)
        {
            ...
            int returnCode = Header.CreateProcess(prog, param, IntPtr.Zero,
        ...
        public static void Stream2File(Stream inputStream, string outputFilename)
        {
            ...
            try
            {
                ...
                int readCnt = inputStream.Read(buffer, 0, buffer.Length);
                while (readCnt > 0)
                {
        ...
        private static bool readTagName(string input, ref ArrayList cssStyleGroups)
        {
            ...
            if (k.Trim() != "")
            {
                cssTagNameList.Add(k);
            }

            cssStyleGroups = new ArrayList();

            for (int i = 0; i < cssTagNameList.Count; i++)
            {
        ...
        private static bool readTagDeclare(string input, PropertyList styles)
        {
            ...
            while (nextDeclare != "")
            {
                readOneDeclare(nextDeclare, out string key, out string value);
                if (key != "")
                {
        ...
        public static ArrayList DecodeCssStyle(string input)
        {
            ...
            for (int i = 0; i < cssStyleGroups.Count; i++)
            {
                CssStyleGroupType curItem = (CssStyleGroupType)(cssStyleGroups[i]);
                CssStyleType newCssStyleType = new CssStyleType
                {
                    styleTagName = curItem.styleTagName,
                    tagName = (new CssHeaderStyleType(curItem.styleTagName)).tagName
                };
