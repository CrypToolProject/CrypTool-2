...
#pragma warning restore 0169, 0649
        ...
        public virtual ICMPv6Types Type
        {
            get
            {
                byte val = header.Bytes[header.Offset + ICMPv6Fields.TypePosition];
        ...
        public override void UpdateCalculatedValues()
        {
            ...
            IPv6Packet ipv6Parent = ParentPacket as IPv6Packet;
            byte[] bytesToChecksum = ipv6Parent.AttachPseudoIPHeader(originalBytes);
