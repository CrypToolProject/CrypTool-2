...
namespace AurelienRibon.Ui.SyntaxHighlightBox
{
    public class HighlighterManager
    {
        ...
        public static HighlighterManager Instance => instance;
        ...
        private HighlighterManager()
        {
            ...
            System.Windows.Resources.StreamResourceInfo gfdgd = Application.GetResourceStream(new Uri("pack://application:,,,/AurelienRibon.Ui.SyntaxHighlightBox;component/resources/syntax.xsd"));
            Stream schemaStream = gfdgd.Stream;
            ...
            foreach (KeyValuePair<string, UnmanagedMemoryStream> res in GetResources("resources/(.+?)[.]xml"))
            {
