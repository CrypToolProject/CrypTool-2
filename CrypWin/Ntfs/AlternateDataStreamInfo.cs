...
namespace Trinet.Core.IO.Ntfs
{
    ...
    public sealed class AlternateDataStreamInfo : IEquatable<AlternateDataStreamInfo>
    {
        ...
        public FileStreamType StreamType => _streamType;
        ...
        /// </value>
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public FileStreamAttributes Attributes => _attributes;
        ...
        public FileStream Open(FileMode mode, FileAccess access, FileShare share, int bufferSize, bool useAsync)
        {
            ...
            Microsoft.Win32.SafeHandles.SafeFileHandle handle = SafeNativeMethods.SafeCreateFile(FullPath, access.ToNative(), share, IntPtr.Zero, mode, flags, IntPtr.Zero);
            if (handle.IsInvalid)
            {
