...
namespace DragDropListBox
{
    public class DragDropHelper
    {
        ...
        {
            ItemsControl dragSource = obj as ItemsControl;
            if (dragSource != null)
            {
        ...
        {
            ItemsControl dropTarget = obj as ItemsControl;
            if (dropTarget != null)
            {
                if (Object.Equals(e.NewValue, true))
                {
        ...
        private void DragSource_PreviewMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if (visual == null || sourceItemsControl.Items.Count <= 1)
            {
                return;
            }
        ...
        private void DropTarget_PreviewDrop(object sender, DragEventArgs e)
        {
            ...
            if (draggedItem != null)
            {
                ...
                if (targetItemsControl is TabControl)
                {
                    ((TabControl)targetItemsControl).SelectedItem = draggedItem;
                }
